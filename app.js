...
// Dynamically create and configure the toggle button
const toggleButton = document.createElement("button");
toggleButton.id = "toggle-btn";
toggleButton.type = "button";
toggleButton.textContent = "Show All Texts";

// Insert the toggle button right after the output container in the DOM
outputContainer.insertAdjacentElement("afterend", toggleButton);
