...
// Helper to attach drag event using a clean File object
    function attachDragEvent(element) {
      element.addEventListener('dragstart', function(e) {
        const finalFileName = nameInput.value.trim() || 'image.jpg';
        
        // Create a real File object directly from our precise currentBlob
        if (currentBlob) {
          const file = new File([currentBlob], finalFileName, { type: 'image/jpeg' });
